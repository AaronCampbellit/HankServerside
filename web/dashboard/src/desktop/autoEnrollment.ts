...
export async function ensureBrowserDesktopIdentity(homeID: string, userID: string, sessionID: string): Promise<DesktopAutoEnrollment> {
  ...
  return desktopTrustClient.autoEnroll({ challenge_id: challenge.challenge_id, challenge: challenge.challenge, installation_id: deviceID,
